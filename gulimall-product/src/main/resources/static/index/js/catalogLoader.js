$(function(){
    $.getJSON("http://localhost:9000/product/html/index/json/catalog.json",function (data) {
...
//                        console.log(cata2link.html());
                        ...
                        $.each(ctg3List,function (i,ctg3) {
                            var cata3link = $("<a href=\"http://search.grainmall.cn/search.html?git="+ctg3.id+"\" style=\"color: #999;\">" + ctg3.name + "</a>");
                            li.append(cata3link);
